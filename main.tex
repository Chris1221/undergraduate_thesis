...
\include{Chapters/methods} % Include the first content chapter
\include{Chapters/results} % Include the second content chapter
\include{Chapters/discussion} % Include the third content chapter
